...
const Offers = () => {
  return (
    ...
    <div className={Styles.offers}>
        ...
        <div className={Styles.offers_item}>
        <Image src="/image/from_img.jpg" width={100} height={100} className={Styles.offers_img} />
        </div>
        <div className={Styles.offers_item}>
        <Image src="/image/newimg.png" width={100} height={100} className={Styles.offers_img} />
        </div>
