      ...
      <div className={Styles.resort_box}>
        <div className={Styles.resort_container}>
          <div className={Styles.resort_img}>
            <Image src="/image/restaurent_oscenox.jpeg" width={100} height={100} className={Styles.explore} />
          </div>
          <div
        ...
        <div className={Styles.resort_container}>
          ...
          <Image src="/image/resort_3.jpg" width={100} height={100} className={Styles.explore} />
          </div>
          <div
            className={`${Styles.resort_overlay} ${Styles.resort_overlayleft}`}
          >
        ...
        <div className={Styles.resort_container}>
          ...
          <Image src="/image/resort_4.jpeg" width={100} height={100} className={Styles.explore} />
          </div>
          <div
            className={`${Styles.resort_overlay} ${Styles.resort_overlayleft}`}
          >
        ...
        <div className={Styles.resort_container}>
          ...
          <Image src="/image/resort_5.jpg" width={100} height={100} className={Styles.explore} />
          </div>
          <div
            className={`${Styles.resort_overlay} ${Styles.resort_overlayleft}`}
          >
        ...
        <div className={Styles.resort_container}>
          ...
          <Image src="/image/resort_6.png" width={100} height={100} className={Styles.explore} />
          </div>
          <div
            className={`${Styles.resort_overlay} ${Styles.resort_overlayleft}`}
          >
        ...
        <div className={Styles.resort_container}>
          ...
          <Image src="/image/resort_8.jpg" width={100} height={100} className={Styles.explore} />
          </div>
          <div
            className={`${Styles.resort_overlay} ${Styles.resort_overlayleft}`}
          >
